  ...
  theme: {
    extend: {
      colors: {
        ...
        breakeven: "rgb(var(--c-breakeven) / <alpha-value>)",
        "seg-bg": "rgb(var(--c-seg-bg) / <alpha-value>)",
        "seg-active": "rgb(var(--c-seg-active) / <alpha-value>)",
        "breakeven-row": "rgb(var(--c-breakeven-row) / <alpha-value>)",
      },
      fontFamily: {
        display: [
          "-apple-system",
